...
if (is_chrome) {
  document.write(
    '<link rel="stylesheet" href="./styles/chrome.css" type="text/css" />'
  );
}
...
window.addEventListener("keydown", (event) => {
  if (event.code === "Space") {
    ...
    if (screenOnOff % 2 != 0) {
      ...
      containerScreen.style.background =
        "linear-gradient(225deg, #e6f4fd 0%, #d5cccd 100%)";
      containerScreen.style.boxShadow =
        "inset 6px 0px 13px #adb7be, inset -6px 0px 13px #c1cbd3";
    }
  }
});
...
clickDown.addEventListener("mousedown", () => {
  clickDown.style.background =
    "linear-gradient(to bottom, #00000000, #000000a0)";
...
clickRight.addEventListener("mousedown", () => {
  clickRight.style.background =
    "linear-gradient(to right, #00000000, #000000a0)";
...
window.addEventListener("keydown", (event) => {
  if (event.code === "ShiftRight") {
    ...
    clickLeft.style.background =
      "linear-gradient(to left, #00000000, #000000a0)";
    if (colNumber <= 3 && colNumber > 1) {
      unselectBox();
      colNumber = colNumber - 1;
      selectBox();
    ...
    if (nbPlay < boxArray.length) {
      for (i = 0; i <= boxArray.length - 1; i++) {
        ...
        if (boxState === "0") {
          ...
          const freeBoxListElement = boxArray.find((search) => search.nb == i)
            .class;
...
function winCheck() {
  ...
  if (
    winCheckList[0] === winCheckList[1] &&
    winCheckList[0] === winCheckList[2] &&
    winCheckList[0] !== "0"
  ) {
    if (winCheckList[0] === "1") {
      winner = "A";
    ...
    winCheckList[3] === winCheckList[4] &&
    winCheckList[3] === winCheckList[5] &&
    winCheckList[3] !== "0"
  ) {
    if (winCheckList[3] === "1") {
      winner = "A";
    ...
    winCheckList[6] === winCheckList[7] &&
    winCheckList[6] === winCheckList[8] &&
    winCheckList[6] !== "0"
  ) {
    if (winCheckList[6] === "1") {
      winner = "A";
    ...
    winCheckList[0] === winCheckList[3] &&
    winCheckList[0] === winCheckList[6] &&
    winCheckList[0] !== "0"
  ) {
    if (winCheckList[0] === "1") {
      winner = "A";
    ...
    winCheckList[1] === winCheckList[4] &&
    winCheckList[1] === winCheckList[7] &&
    winCheckList[1] !== "0"
  ) {
    if (winCheckList[1] === "1") {
      winner = "A";
    ...
    winCheckList[2] === winCheckList[5] &&
    winCheckList[2] === winCheckList[8] &&
    winCheckList[2] !== "0"
  ) {
    if (winCheckList[2] === "1") {
      winner = "A";
    ...
    winCheckList[0] === winCheckList[4] &&
    winCheckList[0] === winCheckList[8] &&
    winCheckList[0] !== "0"
  ) {
    if (winCheckList[0] === "1") {
      winner = "A";
    ...
    winCheckList[2] === winCheckList[4] &&
    winCheckList[2] === winCheckList[6] &&
    winCheckList[2] !== "0"
  ) {
    if (winCheckList[2] === "1") {
      winner = "A";
